...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    blurb: "Play your cards face down and say what they are. Lying is allowed.",
    hook: "Sach bolo... ya phir bluff maaro!",
    emoji: "😈",
    kind: "Bluffing",
    minPlayers: 2,
    maxPlayers: 8,
    ...
    art: ["KS", "7D", "KC"],
    quickPlay: [
      { href: "/games/bluff/play?mode=cpu", label: "vs Computer", icon: "🤖" },
      { href: "/games/bluff/play?mode=friends", label: "With Friends", icon: "👥" },
    ],
  },
  {
    id: "trump_patta",
